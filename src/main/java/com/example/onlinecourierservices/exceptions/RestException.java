package com.example.onlinecourierservices.exceptions;
...
public class RestException extends RuntimeException {
    ...
    private List<ApiResult.ErrorData> errors;
    ...
    private RestException(HttpStatus status, List<ApiResult.ErrorData> errors) {
        this.status = status;
        this.errors = errors;
    }
    ...
    private RestException(String userMsg, int errorCode, HttpStatus status) {
        super(userMsg);
        this.errors = Collections.singletonList(new ApiResult.ErrorData(userMsg, errorCode));
        this.userMsg = userMsg;
        this.status = status;
    }
...
//        this.errorCode = RestConstants.NO_ITEMS_FOUND;
    ...
    public static RestException restThrow(List<ApiResult.ErrorData> errors, HttpStatus status) {
