...
public class ExceptionHelper {
    ...
    public ResponseEntity<ApiResult<ApiResult.ErrorData>> handleException(RestException ex) {
        ex.printStackTrace();
    ...
    public ResponseEntity<?> handleException(MethodArgumentNotValidException ex) {
        ex.printStackTrace();
        List<ApiResult.ErrorData> errors = new ArrayList<>();
        ex.getBindingResult().getAllErrors().forEach((error) -> {
            ...
            errors.add(new ApiResult.ErrorData(errorMessage, HttpStatus.BAD_REQUEST.value(), fieldError.getField()));
        });
